...
import com.dpplabs.project.cermatigithubuser.presentation.util.AnimationListener;
import com.dpplabs.project.cermatigithubuser.presentation.util.AnimatorListener;
...
public class AnimationManager {
    ...
    private static void startSearchViewAnimation(final MainViewHolder viewHolder, final Function<Void> onAnimationFinish) {
        ...
        searchViewAnim.addListener(new AnimatorListener() {
            @Override
            public void onAnimationEnd(Animator animator) {
                try {
